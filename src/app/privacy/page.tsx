...
const PrivacyPage = () => (
  <main className="mx-auto max-w-3xl px-4 py-10 text-sm leading-6">
    ...
    <h2 className="mt-8 text-lg font-medium">Consent management &amp; advertising</h2>
    <p className="mt-2 text-dim">
      If advertising is active, we use Google AdSense together with Google&apos;s certified consent
      management platform (TCF 2.2). Ads, cookies and any profiling only run after your explicit
      consent via the consent dialog (Art. 6(1)(a) GDPR). You can withdraw or change your choice
      at any time:
    </p>
    <button
